...
@Config
@TeleOp (name = "alliance tele right")
public class AllianceTeleop extends LinearOpMode {
    ...
    //public final Pose AlliancePose = new Pose(130.728, 80.175, -3.069);

    private final Pose AlliancePose = new Pose(101.8723, 127.829, -1.46);
    ...
    public void runOpMode() {
        ...
        follower.setStartingPose(AlliancePose);

...
@Config
@TeleOp (name = "Leftside Teleop back")
public class BackTeleLeft extends LinearOpMode {
    ...
    private final Pose shortshot = new Pose(128.281, 62.47, 3.0758);

    private final Pose endAutoPose = new Pose(102.162, 29.206, -1.4929);

...
public class EnlightenedAuto extends OpMode {
    ...
    //plotting the points for usage: 8 of them
    private final Pose initialpose = new Pose(56, 8, Math.toRadians(180));

    private final Pose readyForPickup1 = new Pose(56, 36, Math.toRadians(180));

    private final Pose readyForShot1 = new Pose(10.55, 35.8, Math.toRadians(180));

    private final Pose readyForPickup2 = new Pose(57.38, 59.35, Math.toRadians(-180));

    private final Pose readyForShot2 = new Pose(11.65, 59.35, Math.toRadians(-180));


    private final Pose readyForPickup3 = new Pose(56.7, 83.542, Math.toRadians(180));


    private final Pose readyForShot3 = new Pose(9.67, 83.76, Math.toRadians(180));

    private final Pose ShotPosition = new Pose(58.699, 83.762, Math.toRadians(135));

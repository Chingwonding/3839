...
@Config
@TeleOp (name = "carti tele Left")
public class FrontTeleLeft extends LinearOpMode {
    ...
    //private final Pose shortshot = new Pose(113.455, 74.849, 3.07);
    //private final Pose shortshot = new Pose(92.106, 75.4, -3.11);


    //private final Pose shortshot = new Pose(119.684, 75.099, 3.07);
    private final Pose shortshot = new Pose(100.77, 69.172, 2.39);


    private final Pose four = new Pose(81.2144, 131.319, -2.40);
